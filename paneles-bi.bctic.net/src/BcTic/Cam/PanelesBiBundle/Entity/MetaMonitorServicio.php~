 ...
 * MetaMonitorServicio
 *
 * @ORM\Table(name="META_MONITOR_SERVICIO", uniqueConstraints={@ORM\UniqueConstraint(name="unique_idx", columns={"area", "sistema", "mes", "anno"})})
 * @ORM\Entity
 */
class MetaMonitorServicio
{
    /**
     * @var string
     *
